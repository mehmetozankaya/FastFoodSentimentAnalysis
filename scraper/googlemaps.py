...
class GoogleMapsScraper:
    ...
    def __get_driver(self, debug=False):
        ...
        input_driver = webdriver.Chrome('/Volumes/A/BDAT/SEM2/07_Social_Data_Mining_Techniques/Assignments/finalAssignment/scraper/chromedriver',chrome_options=options)
